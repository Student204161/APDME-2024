...
class App(QWidget):
    def __init__(self, net: XMem, 
        ...
        # Explainer text
        explainer_text = QLabel('Choose the object of interest by left-click and right-click to exclude. \n Then forward propagate the model to obtain segmentaiton masks. \n You may go back and forth in masks as seen fit to get acceptable masks. \nClose the program after all images have been masked to continue')
        explainer_text.setAlignment(Qt.AlignmentFlag.AlignTop)
        # Minimap area
        ...
        minimap_area.addWidget(explainer_text)
    ...
    def on_pause(self):
        ...
        self.console_push_text('Propagation stopped. \n When finished propagation, go ahead and close the editor to continue')
